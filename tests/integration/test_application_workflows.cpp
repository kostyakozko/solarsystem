...
int main() {
  ...
  TEST_CASE("Error Handling") {
    ...
    std::string invalid_date_command = "./solar_system --date invalid-date";
  ...
  TEST_CASE("Installation Verification") {
    ...
    std::vector<std::string> expected_files = {
        "./solar_system_launcher", "./bin/solar_system", "./bin/solar_system_fetch",
        "./bin/solar_system_realtime", "./bin/solar_system_web"};
