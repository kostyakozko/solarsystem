...
TEST(ComponentInterfaceAndCommunicationIntegrationTestsTest,
     API_Contract_and_Compatibility_Testing) {
...
TEST(ComponentInterfaceAndCommunicationIntegrationTestsTest,
     Configuration_Sharing_and_Consistency) {
  auto test_env = TestDataManager::create_test_environment();
  std::string config_dir = test_env->path_string();

  // Test 3.1: Shared configuration file
  {
    std::string config_file = ComponentInterfaceTestUtils::create_test_config(config_dir);
...
TEST(ComponentInterfaceAndCommunicationIntegrationTestsTest,
     Component_Lifecycle_and_State_Management) {
