...
class DateTimeComprehensiveTests {
 ...
 private:
  static void test_basic_date_parsing() {
    ...
    std::vector<std::string> valid_dates = {"2025-12-31", "2025-12-31T23:59:59", "12/31/2025",
                                            "December 31, 2025"};
  ...
  static void test_date_validation() {
    // Test invalid dates
    std::vector<std::string> invalid_dates = {"", "invalid-date", "2025-13-32", "32/13/2025"};
  ...
  static void test_performance() {
    ...
    std::vector<std::string> dates = {"2025-01-01", "2025-06-15", "2025-12-31",
