...
class LoadGenerator {
 ...
 public:
  ...
  TEST_CASE("Realistic Concurrent Usage Patterns") {
  ...
  TEST_CASE("High-Load Scenario with Resource Monitoring") {
    ResourceMonitor monitor;
  ...
  TEST_CASE("Concurrent Data Modification and Consistency") {
  ...
  TEST_CASE("Performance Under Concurrent Load") {
    ResourceMonitor monitor;
    ConcurrentDataStore<int, int> store;
  ...
  TEST_CASE("Stress Test with Load Generator") {
    ResourceMonitor monitor;
    ConcurrentDataStore<int, int> store;
  ...
  TEST_CASE("Concurrent Insert and Remove Operations") {
    ConcurrentDataStore<int, int> store;
    const int num_threads = 10;
    const int operations_per_thread = 100;
  ...
  TEST_CASE("Memory Pressure Test") {
    ResourceMonitor monitor;
    ConcurrentDataStore<int, std::vector<int>> store;
