...
TEST(EdgeCaseandBoundaryTests, CelestialBody___Minimum_mass) {
  CelestialBody::Properties props{.name = "Tiny",
...
TEST(EdgeCaseandBoundaryTests, CelestialBody___Maximum_mass) {
  CelestialBody::Properties props{.name = "Massive",
...
TEST(EdgeCaseandBoundaryTests, CelestialBody___Extreme_positions) {
  CelestialBody::Properties props{.name = "Distant",
                                  .mass = 1e24,
...
TEST(EdgeCaseandBoundaryTests, BodyCollection___Single_body) {
  BodyCollection collection;
  collection.add_body(CelestialBody::Properties{.name = "Single",
                                                .mass = 1.0,
                                                .position = Vector3d{},
                                                .velocity = Vector3d{},
                                                .type = BodyType::Planet,
...
TEST(EdgeCaseandBoundaryTests, CelestialBody___Long_name) {
  ...
  CelestialBody::Properties props{.name = long_name,
                                  .mass = 1.0,
                                  .position = Vector3d{},
                                  .velocity = Vector3d{},
                                  .type = BodyType::Planet,
...
TEST(EdgeCaseandBoundaryTests, CelestialBody___Special_characters_in_name) {
  CelestialBody::Properties props{.name = "Test-Body_123!@#",
                                  .mass = 1.0,
                                  .position = Vector3d{},
                                  .velocity = Vector3d{},
                                  .type = BodyType::Planet,
...
TEST(EdgeCaseandBoundaryTests, BodyCollection___Concurrent_reads) {
  BodyCollection collection;
  collection.add_body(CelestialBody::Properties{.name = "Shared",
                                                .mass = 1.0,
                                                .position = Vector3d{},
                                                .velocity = Vector3d{},
                                                .type = BodyType::Planet,
...
TEST(EdgeCaseandBoundaryTests, CelestialBody___Zero_mass) {
  CelestialBody::Properties props{.name = "ZeroMass",
                                  .mass = 0.0,
                                  .position = Vector3d{},
                                  .velocity = Vector3d{},
                                  .type = BodyType::Planet,
