...
TEST(DataValidatorTests, Validation_Utilities) {
  ...
  ASSERT_FALSE(
      ValidationUtils::is_reasonable_astronomical_value(100.0, "position_km"));  // Too small
  ASSERT_FALSE(
      ValidationUtils::is_reasonable_astronomical_value(1e15, "position_km"));  // Too large

  ASSERT_TRUE(ValidationUtils::is_reasonable_astronomical_value(
      30.0, "velocity_km_s"));  // Earth orbital velocity
  ASSERT_FALSE(
      ValidationUtils::is_reasonable_astronomical_value(2e6, "velocity_km_s"));  // Too large

  ASSERT_TRUE(
      ValidationUtils::is_reasonable_astronomical_value(5.972e24, "mass_kg"));      // Earth mass
