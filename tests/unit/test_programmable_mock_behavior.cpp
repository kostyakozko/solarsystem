...
TEST(ProgrammableMockBehavior, FlexibleMockConfiguration) {
...
TEST(ProgrammableMockBehavior, ConditionalMockResponses) {
  ProgrammableMock mock;
...
TEST(ProgrammableMockBehavior, MockInteractionRecording) {
  ProgrammableMock mock;
...
TEST(ProgrammableMockBehavior, MockResponsePlayback) {
  ProgrammableMock mock;
...
TEST(ProgrammableMockBehavior, IntegratedProgrammableMockScenarios) {
  ProgrammableMock mock;
