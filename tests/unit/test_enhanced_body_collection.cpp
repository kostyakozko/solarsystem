...
TEST(EnhancedBodyCollectionTestsTask5, Update_Body_Operation) {
  ...
  collection.add_body(CelestialBody::Properties{.name = "TestBody",
                                                .mass = 1000.0,
...
TEST(EnhancedBodyCollectionTestsTask5, Name_Pattern_Search) {
  ...
  collection.add_body(CelestialBody::Properties{.name = "Europa",
                                                .mass = 4.8e22,
                                                .position = Vector3d{},
                                                .velocity = Vector3d{},
                                                .type = BodyType::Moon,
...
TEST(EnhancedBodyCollectionTestsTask5, Mass_Range_Filtering) {
  ...
  collection.add_body(CelestialBody::Properties{.name = "LightBody",
                                                .mass = 1000.0,
                                                .position = Vector3d{},
                                                .velocity = Vector3d{},
  ...
  collection.add_body(CelestialBody::Properties{.name = "MediumBody",
                                                .mass = 1.0e20,
                                                .position = Vector3d{},
                                                .velocity = Vector3d{},
  ...
  collection.add_body(CelestialBody::Properties{.name = "HeavyBody",
                                                .mass = 1.0e24,
                                                .position = Vector3d{},
                                                .velocity = Vector3d{},
                                                .type = BodyType::Planet,
...
TEST(EnhancedBodyCollectionTestsTask5, Distance_Filtering) {
  ...
  collection.add_body(CelestialBody::Properties{.name = "NearBody",
                                                .mass = 1000.0,
                                                .position = Vector3d{1.0, 0.0, 0.0},
                                                .velocity = Vector3d{},
                                                .type = BodyType::Planet,
  ...
  collection.add_body(CelestialBody::Properties{.name = "FarBody",
                                                .mass = 1000.0,
...
TEST(EnhancedBodyCollectionTestsTask5, Bulk_Add_Operation) {
  ...
  for (int i = 0; i < 5; ++i) {
    bodies_to_add.emplace_back(
        CelestialBody::Properties{.name = "Body" + std::to_string(i),
                                  .mass = 1000.0 * (i + 1),
...
TEST(EnhancedBodyCollectionTestsTask5, Bulk_Remove_Operation) {
  ...
  for (int i = 0; i < 3; ++i) {
    collection.add_body(
        CelestialBody::Properties{.name = "RemoveMe" + std::to_string(i),
                                  .mass = 1000.0,
                                  .position = Vector3d{},
                                  .velocity = Vector3d{},
                                  .type = BodyType::Planet,
...
TEST(EnhancedBodyCollectionTestsTask5, Bulk_Position_Update) {
  ...
  for (int i = 0; i < 3; ++i) {
    collection.add_body(
        CelestialBody::Properties{.name = "UpdateMe" + std::to_string(i),
                                  .mass = 1000.0,
                                  .position = Vector3d{static_cast<long double>(i), 0.0, 0.0},
                                  .velocity = Vector3d{},
                                  .type = BodyType::Planet,
  ...
  auto result = collection.bulk_update_positions(
      [](const CelestialBody& body) { return body.position() + Vector3d{10.0, 0.0, 0.0}; });
