...
TEST(PortManagement, BasicPortAllocation) {
...
TEST(PortManagement, ScopedPortAllocation) {
...
TEST(PortManagement, MultiplePortAllocation) {
...
TEST(PortManagement, PortRangeAllocation) {
  auto& port_manager = TestPortManager::instance();
...
TEST(PortManagement, ResourceManagerIntegration) {
...
TEST(PortManagement, TestEnvironmentIsolation) {
...
TEST(PortManagement, DiagnosticLoggingIntegration) {
  ...
  EXPECT_NE(std::string::npos, report.find("test_diagnostic"));
}

// Test 8: Performance monitoring
TEST(PortManagement, PerformanceMonitoring) {
...
TEST(PortManagement, SystemStateCapture) {
  ...
  ASSERT_FALSE(report.empty());
  EXPECT_NE(std::string::npos, report.find("System State Report"));
}

// Test 10: Failure analysis
TEST(PortManagement, FailureAnalysis) {
