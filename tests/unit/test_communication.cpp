...
int main() {
  TestSuite suite("Communication Protocol Tests");

  suite.run_test("Message Creation", []() {
  ...
  suite.run_test("Message Validation", []() {
  ...
  suite.run_test("Response Creation", []() {
  ...
  suite.run_test("InProcess Protocol", []() {
  ...
  suite.run_test("Protocol Statistics", []() {
    auto protocol = std::make_shared<InProcessProtocol>();
